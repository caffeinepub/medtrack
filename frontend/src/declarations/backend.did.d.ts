...
export interface _SERVICE {
  ...
  'getRecordDetails' : ActorMethod<[string], [] | [ExternalBlob]>,
  'getRecordsByType' : ActorMethod<
    [RecordType, [] | [string]],
    Array<MedicalRecord>
  >,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'getUserRecords' : ActorMethod<[], Array<[string, ExternalBlob]>>,
  ...
  'listUserFiles' : ActorMethod<[], Array<[string, ExternalBlob]>>,
